...
import { UploadManagement } from "@/components/admin/upload-management/UploadManagement";
...
// Permission checks are handled in /admin/uploads/page.tsx

export default function AdminUploadManagementPage() {
    ...
    <>
      <UploadManagement
        ...
        onOpenUploadPermissions={() =>
          router.push("/admin/uploads/user-permission")
        }
