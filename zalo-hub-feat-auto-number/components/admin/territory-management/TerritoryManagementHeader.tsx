...
import { Map, ArrowLeft, Plus, MoreVertical } from "lucide-react";
import { AdminMenu } from "@/components/ui/admin-menu";

interface TerritoryManagementHeaderProps {
  onBack?: () => void;
  isAdmin?: boolean;
...
export function TerritoryManagementHeader({
  onBack,
  isAdmin = false,
  ...
  rightActions,
}: TerritoryManagementHeaderProps) {
  return (
        ...
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Tạo và quản lý các nhóm</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            {rightActions}
            {onCreateTerritoryClick && (
              <Button onClick={onCreateTerritoryClick}>
